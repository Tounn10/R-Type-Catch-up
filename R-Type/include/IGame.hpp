...
public:
    ...
    virtual void spawnEntity(GeneralEntity::EntityType type, float x, float y) = 0;
    ...
    virtual void checkCollisions(GeneralEntity::EntityType typeA, GeneralEntity::EntityType typeB, float collisionThreshold) = 0;
